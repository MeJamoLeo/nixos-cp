...

{
	wayland.windowManager.sway = {
		...
		config = {
			...
			startup = [
				{ command = "nix-shell /home/treo/nixos-cp/dashboard/shell.nix --keep WAYLAND_DISPLAY --keep XDG_RUNTIME_DIR --run 'python3 /home/treo/nixos-cp/dashboard/dashboard.py'"; }
			];
		};
	};
}
